...
if "%PHPBIN%" == "" set PHPBIN=\Program Files (x86)\Bohemia Interactive\ArmA 2\@DayZ_Blizzard\php\.\php.exe
if not exist "%PHPBIN%" if "%PHP_PEAR_PHP_BIN%" neq "" goto USE_PEAR_PATH
GOTO RUN
:USE_PEAR_PATH
set PHPBIN=%PHP_PEAR_PHP_BIN%
:RUN
"%PHPBIN%" "\Program Files (x86)\Bohemia Interactive\ArmA 2\@DayZ_Blizzard\php\phpunit" %*
