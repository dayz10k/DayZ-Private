...
GOTO doshift
:noshift
\Program Files (x86)\Bohemia Interactive\ArmA 2\@DayZ_Blizzard\php\.\php.exe -q -d output_buffering=1 -d include_path="\Program Files (x86)\Bohemia Interactive\ArmA 2\@DayZ_Blizzard\php\pear" \xampp\php/Text/Highlighter/generate.bat %MHL_PARAMS%
