...
set PHPBIN="\Program Files (x86)\Bohemia Interactive\ArmA 2\@DayZ_Blizzard\php\.\php.exe"
"\Program Files (x86)\Bohemia Interactive\ArmA 2\@DayZ_Blizzard\php\.\php.exe" "\Program Files (x86)\Bohemia Interactive\ArmA 2\@DayZ_Blizzard\php\phptok" %*
