<?
	...
	while ($row=mysql_fetch_array($res)) {
		...
		$description = "<h2><a href=\"index.php?view=info&show=5&id=".$row['unique_id']."\">".$type."</a></h2><table><tr><td><img style=\"max-width: 100px;\" src=\"".$path."images/vehicles/".$type.".png\"></td><td>&nbsp;</td><td style=\"vertical-align:top; \"><h2>Position:</h2>left: ".round(world_x($x,$serverworld))." top: ".round(world_y($y,$serverworld))."</td></tr></table>";
