<?php
	$res = mysql_query("SELECT profile.*, survivor.* FROM `profile`, `survivor` WHERE profile.unique_id = survivor.unique_id AND survivor.unique_id = '".$_GET["id"]."' AND survivor.id = '".$_GET["cid"]."' LIMIT 1") or die(mysql_error());
