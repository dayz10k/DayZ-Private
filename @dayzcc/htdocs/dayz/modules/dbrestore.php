									...
									if (file_exists($settingspath)) {
										...
										if (count($backups) > 0) {
											...
											foreach ($backups as $file) {
												...
												echo '<tr><td width="50%">
													<a href="index.php?view=dbrestore&step=2&file='.(str_replace("\\", "__dir__", $filepath)).'">'.$file.'</a>
								...
								case 3:
									if (isset($_GET['file'])) {
										...
										if (file_exists($file)) {
											...
											echo 'Database created!<br/><br/>Restoring database from file ...<br/>';
											splitSQL($file);
											echo 'Process completed!<br/><br/><br/>
