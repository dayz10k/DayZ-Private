...
<div class="nav-outer"> 
		...
		<div id="nav-right">
			...
			<a href="index.php?view=admin" id="logout"><img src="images/shared/nav/nav_myaccount.gif" width="67" height="14" alt="" /></a>
			<? } ?>
		...
		<div class="mc-nav">
			<div class="table">
				...
				<? } if (strpos($_SESSION['user_permissions'], "tools") !== false) { ?>
