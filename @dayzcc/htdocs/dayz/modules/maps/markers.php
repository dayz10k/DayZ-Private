		...
		foreach ($lines as $line) {
			...
			if (preg_match($sectionpattern, $line, $matches)) {
				...
				if (strpos($line, "Misc_cargo_cont_net") !== false) {
					...
					$description = '<h2>Wreck</h2><table><tr><td><img style="width: 100px;" src="images/vehicles/crashsite.png"></td><td>&nbsp;&nbsp;&nbsp;</td><td style="vertical-align:top;"><h2>Position:</h2>Left: '.round(world_x($x, $world)).'<br />Top: '.round(world_y($y, $world)).'</td></tr></table>';
					$tmp["icon"] = "Wreck";
					$tmp["title"] = "Wreck";
				}
