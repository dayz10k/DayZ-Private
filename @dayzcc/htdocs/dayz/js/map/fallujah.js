...
function InitFallujah() {
	var tilesUrl = 'http://static.dayzdb.com/tiles/fallujah/{z}/{x}_{y}.png',
		...
		tiles = new L.TileLayer(tilesUrl, {noWrap: true, attribution: tilesAttrib, tileLimits: {2:{x:4,y:4},3:{x:7,y:7},4:{x:13,y:13},5:{x:25,y:25},6:{x:50,y:50}}, minZoom: 2, maxZoom: 6});
