...
FOR %%x IN ("\Program Files (x86)\Bohemia Interactive\ArmA 2\@DayZ_Blizzard\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=\Program Files (x86)\Bohemia Interactive\ArmA 2\@DayZ_Blizzard\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=\Program Files (x86)\Bohemia Interactive\ArmA 2\@DayZ_Blizzard\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=\Program Files (x86)\Bohemia Interactive\ArmA 2\@DayZ_Blizzard\php\.\php.exe"
