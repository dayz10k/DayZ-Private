...
"\Program Files (x86)\Bohemia Interactive\ArmA 2\@DayZ_Blizzard\php\.\php.exe" -d auto_append_file="" -d auto_prepend_file="" -d include_path="\Program Files (x86)\Bohemia Interactive\ArmA 2\@DayZ_Blizzard\php\pear" "\xampp\php\phpcs" %*
