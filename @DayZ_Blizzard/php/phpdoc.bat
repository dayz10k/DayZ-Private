...
::            for PHP 4.3 C:\phpdev\php-4.3-Win32\cli\php.exe
  ...
  SET phpCli=\Program Files (x86)\Bohemia Interactive\ArmA 2\@DayZ_Blizzard\php\.\php.exe
...
IF '%1'=='' (
  ...
  "%phpCli%" -d include_path="\Program Files (x86)\Bohemia Interactive\ArmA 2\@DayZ_Blizzard\php\pear" "\Program Files (x86)\Bohemia Interactive\ArmA 2\@DayZ_Blizzard\php\phpdoc" %*
  GOTO :EOF
)
...
:run
SET found=1
ECHO Starting: "%phpCli%" "\Program Files (x86)\Bohemia Interactive\ArmA 2\@DayZ_Blizzard\php\phpdoc" -c "%iniFile%"
ECHO.
"%phpCli%"  -d include_path="\Program Files (x86)\Bohemia Interactive\ArmA 2\@DayZ_Blizzard\php\pear" "\Program Files (x86)\Bohemia Interactive\ArmA 2\@DayZ_Blizzard\php\phpdoc" -c "%iniFile%"
GOTO :EOF
