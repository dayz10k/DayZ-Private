<?php
	...
	*/
	...
	/// Version now without extra file (Crosire) ///
	$xamppversion = "1.8.0";
	...
	if ( $_SERVER["argv"][1] == "usb" )
	{
		...
		echo "\r\n  ########################################################################\n";
		echo "  #                                                                      #\r\n";
		echo "  #  XAMPP Installation (Using Relative Paths)                           #\r\n";;
		echo "  #                                                                      #\r\n";
		echo "  ########################################################################\r\n\r\n";
	}
	...
	*/
	...
	echo "\r\n  ########################################################################\n";
	echo "  #                                                                      #\r\n";
	echo "  #  ApacheFriends XAMPP Setup                                           #\r\n";
	echo "  #                                                                      #\r\n";
	echo "  #  Copyright (c) 2002 - ".date("Y")." Apachefriends $xamppversion                       #\r\n";
	echo "  #                                                                      #\r\n";
	echo "  #  Original Authors: Kay Vogelgesang <kvo@apachefriends.org>           #\r\n";
	...
	if (file_exists($installsysroot))
	{
		...
		while (!feof($datei))
		{
			...
			if ( $zeile == "usbstick = 1" )
			{
				echo "  Non partition installation found! Using relative paths by default.\n";
				echo "  ($nonpartition)";
				echo "\n";
				$dirpartwampp=$nonpartition;
				$usbstick="1";
	...
	for ($q = 2; $q < $werte; $q++)
	{
		...
		*/
		...
		if ((($update == "perl") || ($update == "python") || ($update == "java")) && ($updatemake == "makenew"))
		{
			...
			fclose($datei);
			*/ //Vogelgesang 28.12.06 because obsolet
		}
	...
	if ($xamppinstaller == "newpath")
	{
		...
		while ($BS == "0")
		{
			...
			switch (trim(fgets(NEWSTDIN, 256)))
			{
				...
				case 1:
					$BS = 1;
					echo "\r\n  XAMPP is refreshing the installation ...\r\n";
					sleep(1);
					break;
